...
func TestBlockTypeToString(t *testing.T) {
	...
	for _, pair := range testpairs {
		if res := en.BlockTypeToString(pair.code); res != pair.block {
...
func TestExtractCoordinates(t *testing.T) {
	var examples = []struct {
		...
		{`<a href="geo:49.976136, 36.267256">49.976136, 36.267256</a>`, "49.976136, 36.267256",
			en.Coordinates{{Lon: 49.976136, Lat: 36.267256, OriginalString: "49.976136, 36.267256"}}},
		{`<a href="https://www.google.com.ua/maps/@50.0363257,36.2120039,19z" target="blank">50.036435 36.211914</a>`, "50.036435 36.211914",
			en.Coordinates{{Lon: 50.036326, Lat: 36.212004, OriginalString: "50.036435 36.211914"}}},
	}

	//"49.976136, 36.267256"
	for _, ex := range examples {
		if res, _ := en.ExtractCoordinates(ex.input); res != ex.expected {
			t.Errorf("For %q\nExpected %q\nGot      %q",
